...
// #define DEBUG
#ifndef DEBUG
    static const char* const cube_vs = "src/Demo13/cube.vs";
    static const char* const cube_fs = "src/Demo13/cube.fs";
    static const char* const light_vs = "src/Demo13/light.vs";
    static const char* const light_fs = "src/Demo13/light.fs";
    ...
    static const char* const nanosuit_vs = "src/Demo13/nanosuit.vs";
    static const char* const nanosuit_fs = "src/Demo13/nanosuit.fs";
    static const char* const depthcolor_fs = "src/Demo13/depthcolor.fs";
#else
    static const char* const cube_vs = "../src/Demo13/cube.vs";
    static const char* const cube_fs = "../src/Demo13/cube.fs";
    static const char* const light_vs = "../src/Demo13/light.vs";
...
Demo13::Demo13(uint width, uint height):DemoBase(width,height){
    // 设置窗体回调函数
    ...
    m_rect.init(cube_vs, depthcolor_fs, vecVert, vecId);
    ...
    m_lightCube.init(light_vs, depthcolor_fs, vecVert, vecId);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*)0);
    glEnableVertexAttribArray(0);  // 1. 设置顶点属性指针
    ...
    m_shader.init(cube_vs, depthcolor_fs);
...
uint Demo13::generateTexture(string imgPath, uint filterType, uint repeatType){
    int width, height;
    uint tex;
    // 加载图片
...
void Demo13::dirLightingRenderTest(){
...
void Demo13::pointLightingRenderTest(){
...
void Demo13::spotLightingRenderTest(){
    m_rect.render();
    vec3 lightColor(1);
...
void Demo13::mixLightingRenderTest(){
    m_rect.render();
    vec3 lightColor(1);
