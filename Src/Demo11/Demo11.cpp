...
//  #define DEBUG
#ifndef DEBUG
    static const char* const cube_vs = "src/Demo11/cube.vs";
    static const char* const cube_fs = "src/Demo11/cube.fs";
    static const char* const light_vs = "src/Demo11/light.vs";
    static const char* const light_fs = "src/Demo11/light.fs";
...
Demo11::Demo11(uint width, uint height):DemoBase(width,height){
    // 设置窗体回调函数
...
uint Demo11::generateTexture(string imgPath, uint filterType, uint repeatType){
    int width, height;
    uint tex;
    // 加载图片
...
void Demo11::dirLightingRenderTest(){
...
void Demo11::pointLightingRenderTest(){
...
void Demo11::spotLightingRenderTest(){
    m_rect.render();
    vec3 lightColor(1);
...
void Demo11::mixLightingRenderTest(){
    m_rect.render();
    vec3 lightColor(1);
