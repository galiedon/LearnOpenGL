...
// #define DEBUG
#ifndef DEBUG
    static const char* const cube_vs = "src/Demo14/cube.vs";
    static const char* const cube_fs = "src/Demo14/cube.fs";
    static const char* const light_vs = "src/Demo14/light.vs";
    static const char* const light_fs = "src/Demo14/light.fs";
    ...
    static const char* const nanosuit_vs = "src/Demo14/nanosuit.vs";
    static const char* const nanosuit_fs = "src/Demo14/nanosuit.fs";
    static const char* const depthcolor_fs = "src/Demo14/depthcolor.fs";
    static const char* const shaderSingleColor_fs = "src/Demo14/shaderSingleColor.fs";
#else
    static const char* const cube_vs = "../src/Demo14/cube.vs";
    static const char* const cube_fs = "../src/Demo14/cube.fs";
    static const char* const light_vs = "../src/Demo14/light.vs";
...
Demo14::Demo14(uint width, uint height):DemoBase(width,height){
    // 设置窗体回调函数
    ...
    // 设置模板shader
    m_stencilShader.init(cube_vs, shaderSingleColor_fs);

    // 初始化Depth Mode
    m_depth_mode = GL_LESS;
...
void Demo14::render(){
    ...
    m_stencilShader.use();
    auto model = scale(mat4(1.f), vec3(0.201f));
    m_stencilShader.setMat4("model", GL_FALSE, model);
    m_stencilShader.setMat4("view", GL_FALSE, m_camera.getViewMatrix());
    m_proj = perspective(radians(m_camera.m_zoom), (float)m_size.width/m_size.height, 0.1f, 100.0f);
    m_stencilShader.setMat4("proj", GL_FALSE, m_proj);
    m_nanosuit.Render(m_stencilShader);
    glStencilMask(0xFF);
...
uint Demo14::generateTexture(string imgPath, uint filterType, uint repeatType){
    int width, height;
    uint tex;
    // 加载图片
...
void Demo14::dirLightingRenderTest(){
...
void Demo14::pointLightingRenderTest(){
...
void Demo14::spotLightingRenderTest(){
    m_rect.render();
    vec3 lightColor(1);
...
void Demo14::mixLightingRenderTest(){
    m_rect.render();
    vec3 lightColor(1);
